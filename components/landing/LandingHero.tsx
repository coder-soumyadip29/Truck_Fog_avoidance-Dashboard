    ...
    <div className="min-h-screen bg-[#05050A] text-slate-100 relative overflow-hidden bg-hex-pattern">
      ...
      <nav className="w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between z-20 relative">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-900 border border-slate-800 text-xs font-mono text-emerald-400">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-mono font-bold text-xs shadow-lg shadow-cyan-500/25 border border-cyan-300 transition-all hover:scale-105 active:scale-95"
          >
      ...
      <div className="max-w-7xl mx-auto px-6 pt-12 pb-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-cyan-500/40 text-cyan-400 text-xs font-mono font-semibold">
              <Radio className="w-4 h-4 text-cyan-400 animate-pulse" />
              <span>NEXT-GEN 24GHz mmWAVE RADAR & 3D DIGITAL TWIN</span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <button
                onClick={() => setIsAuthModalOpen(true)}
                className="flex items-center gap-3 px-8 py-4 rounded-2xl bg-cyan-400 hover:bg-cyan-300 text-slate-950 font-mono font-extrabold text-sm shadow-[0_0_35px_rgba(0,229,255,0.4)] transition-all hover:scale-105"
              >
                <span>ENTER CABIN DASHBOARD</span>
                <ArrowRight className="w-5 h-5" />
              </button>

              <div className="flex items-center gap-3 px-5 py-3.5 rounded-2xl glass-panel text-slate-300 font-mono text-xs border border-slate-700">
            ...
            {/* Live Pit Stats Bar */}
            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-slate-800/80 font-mono">
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-cyan-400">2,480+</div>
                <div className="text-[11px] text-slate-400">ACTIVE SHIFTS</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-emerald-400">0</div>
                <div className="text-[11px] text-slate-400 font-bold">CAS COLLISIONS</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-amber-400">99.9%</div>
                <div className="text-[11px] text-slate-400">RADAR UPTIME</div>
              </div>
            </div>
          </div>
